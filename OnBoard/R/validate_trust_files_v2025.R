...
writexl::write_xlsx(suspicious_all, "../../edits/suspicious_w.xlsx")
...
ggsave("../../edits/suspecious_w.png", width = 42, height = 20, units='cm')
...
ggsave("../../edits/sospicius_w_murici.png", width = 42, height = 20, units='cm')
...
ggsave("../../edits/suspicious_n.png", width = 42, height = 20, units='cm')
...
dat_ARNOLAT<-dat_store[dat_store$SpecCode=='ARNOLAT'&dat_store$l_mm<50,] # this needs to be adapted to check species that are suspicious in the previous plot
dat_GOBINIG<-dat_store[dat_store$SpecCode=='GOBINIG'&dat_store$l_mm<40,] # this needs to be adapted to check species that are suspicious in the previous plot
dat_BUGGLUT<-dat_store[dat_store$SpecCode=='BUGLLUT'&dat_store$l_mm<25,] # this needs to be adapted to check species that are suspicious in the previous plot
...
dat_TRIGLUC<-dat_store[dat_store$SpecCode=='TRIGLUC'&dat_store$l_mm<100,] # this needs to be adapted to check species that are suspicious in the previous plot
...
dat_n_non_target<-rbind(dat_ARNOLAT,dat_GOBINIG,dat_BUGGLUT,dat_TRIGLUC)%>%
